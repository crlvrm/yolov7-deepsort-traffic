...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : './yolov7tiny/model_data/yolov7_tiny_weights.pth',
        "classes_path"      : './yolov7tiny/model_data/coco_classes.txt',
        #---------------------------------------------------------------------#
        #   anchors_path代表先验框对应的txt文件，一般不修改。
        #   anchors_mask用于帮助代码找到对应的先验框，一般不修改。
        #---------------------------------------------------------------------#
        "anchors_path"      : './yolov7tiny/model_data/yolo_anchors.txt',
    ...
    def detect_image(self, image, crop=False, count=False):
        ...
        for i, c in list(enumerate(top_label)):
            if c == 2 or c == 3 or c == 5 or c == 6 or c == 7:
                ...
                if top < 300 and left > 700 and c != 5:
                    continue
                if left < 130 and top < 180 and c != 5:
                    continue
                if top < 100:
                    continue

                boxes.append((top, left, bottom, right, c, score))
